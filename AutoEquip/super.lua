...
function SELFAQ.superInit()
    ...
    p.name = L["AutoEquip Super Equip"]
    p.parent = "AutoEquip"
    ...
    SELFAQ.takeoffOne = function(slot)
        ...
        for i=0,NUM_BAG_SLOTS do
            ...
            for s=1,count do
                ...
                if not C_Container.GetContainerItemInfo(i,s) and not hold[index] then
    ...
    SELFAQ.putOne2Bank = function( item_id )
        ...
        if C_Container.GetContainerNumSlots(10) == 0 then
            return
        end
        ...
        for k,i in pairs(bank) do
            ...
            if count and count > 0 then
                ...
                for s=1,count do
                    ...
                    local index = i*100 +s
                    print(C_Container.GetContainerItemInfo(i,s))
    ...
    category, layout = Settings.RegisterCanvasLayoutCategory(p, p.name, p.name);
    category.ID = p.name
