...
function SELFAQ.settingInit()
    ...
    p.name = L["AutoEquip General"]
    p.parent = "AutoEquip"

    queueOption.name = L["AutoEquip Usable Queue"]
    ...
    category, layout = Settings.RegisterCanvasLayoutCategory(p,p.name);
    category.ID = p.parent
    Settings.RegisterAddOnCategory(category);

    category, layout = Settings.RegisterCanvasLayoutCategory(top, top.name);
    category.ID = top.parent
    Settings.RegisterAddOnCategory(category);

    category, layout = Settings.RegisterCanvasLayoutCategory(queueOption, queueOption.name);
    category.ID = queueOption.name
    Settings.RegisterAddOnCategory(category);
